...
import webbrowser
import os
import ravenclaw_toolkit.constants
...
def display_page(book, page, lines):
    if lines:
        webbrowser.open(rf"file://{os.path.join(os.getcwd(), 'ravenclaw_toolkit', 'static', f'HP{book}', f'hp{book}_{page}_lines.png')}")
    else:
        webbrowser.open(rf"file://{os.path.join(os.getcwd(), 'ravenclaw_toolkit', 'static', f'HP{book}', f'hp{book}_{page}.png')}")
